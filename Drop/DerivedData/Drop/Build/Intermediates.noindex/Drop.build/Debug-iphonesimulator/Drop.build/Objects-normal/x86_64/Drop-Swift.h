...
SWIFT_MODULE_NAMESPACE_PUSH("Drop")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC4Drop11AppDelegate")
...
SWIFT_CLASS("_TtC4Drop19EventViewController")
...
@interface EventViewController (SWIFT_EXTENSION(Drop)) <UICollectionViewDataSource, UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC4Drop19LoginViewController")
@interface LoginViewController : UIViewController
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified username_input;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified passowrd_input;
@property (nonatomic, strong) IBOutlet UIButton * _Null_unspecified login_button;
